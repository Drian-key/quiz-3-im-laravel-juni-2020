...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content-headerddddddddd -->

    <img src="{{ asset('ERD.png')}}" alt="User Avatar" class="img-size-50 mr-3 img-circle')}}">
    
		<a class="btn btn-primary" href="artikel" role="button">Create artikel</a>
